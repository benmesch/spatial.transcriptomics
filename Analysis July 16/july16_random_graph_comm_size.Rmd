...
**^Need to set a palette of 23 colors (# of cell types) globally. Then every cell type is converted to an integer (and that integer is used to lookup from the global palette).**

**^^Also need to make sure communities are opacity / alpha low, so overlapping communities can be seen**
